...
coordination, and verification throughout the capstone project. Our
approach relied on practical business-style processes that were
appropriate for a small software team, including milestone planning,
issue tracking, pull-request review, documented role ownership, and
traceability between plans, tests, and final evidence.
...
communication, and GitHub Issues and pull requests as the main workflow
for tracking work and reviewing changes. We also stayed broadly aligned
with the technology plan by building the system around Python, a
TypeScript/React interface, automation tooling, and a GitHub-based
review process.
...
simple tools consistently. GitHub Issues, pull requests, and the GitHub
project board gave us a shared source of truth for tasks, review status,
and progress, while Discord helped us resolve blockers quickly between
meetings. The modular decomposition of the system also helped with time
and resource management because different members could work on input
handling, UI, automation, testing, and documentation in parallel with
less overlap than a more tightly coupled design would have allowed.

Another process that worked well was connecting project management to
verification rather than treating testing as a final-step activity. The
V\&V Plan, design reviews, checklist-based inspections, and later unit,
integration, and system testing gave us structured checkpoints for
judging whether work was actually ready. This improved accountability,
...
role table can capture. As a result, some work could not progress as
...
clearer traceability ownership, and fuller tool justification, were only
strengthened after external feedback rather than being fully mature from
the beginning.
...
would improve time management, reduce last-minute scope pressure, and
make resource decisions more deliberate and effective.
