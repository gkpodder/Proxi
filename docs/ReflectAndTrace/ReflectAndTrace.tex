...
% Improve line breaking and reduce minor spacing/overflow issues.
...
\section{Design Iteration (LO11: Prototype Iteration)}
...
\medskip
\noindent\textbf{Iteration 1: one-shot flow to agent loop.} We introduced an agent loop
...
\medskip
\noindent\textbf{Iteration 2: tightly coupled integrations to MCP integrations.} As the
...
\medskip
\noindent\textbf{Iteration 3: separate interface logic to shared gateway.} Early versions
...
\medskip
\noindent\textbf{Iteration 4: selected MCP flows to direct CLI tools.} For common,
...
This capstone was especially valuable because it required end-to-end
software engineering rather than isolated course assignments. We had to
move from requirements and hazard analysis, to architectural design,
implementation across multiple components, verification and validation,
and finally documentation and traceability. That made the project a much
more realistic exercise in systems integration, engineering tradeoffs,
and maintaining consistency between requirements, design decisions, code,
and evidence.

Several courses gave us a strong foundation for this work, but the
capstone forced us to apply that knowledge in a more connected and
practical way.
Instead of treating requirements, testing, interface design, and
security as separate topics, Proxi required us to combine them into one
coherent engineering process.

\subsection{Which Courses Were Relevant}

Several courses were especially relevant because they mapped directly
onto the engineering artifacts we produced for Proxi. SFWRENG 3RA3
(Software Requirements \& Security Considerations) was useful when
writing the SRS and hazard analysis, since it emphasized precise
requirements, stakeholder-driven thinking, privacy and safety concerns,
and traceability rather than jumping straight into implementation.
SFWRENG 3S03 (Software Testing) was equally important because our
capstone required a real V\&V process with test planning, unit and
integration testing, system-level checks, and evidence-based reporting
instead of informal feature demos.

The software design sequence, especially SFWRENG 3BB4 and SFWRENG 3A04,
was important for the architectural side of the project. The separation
between the gateway, integrations, memory, and multiple user interfaces
was not just a coding choice; it was an engineering decision about
modularity, maintainability, and extensibility. SFWRENG 4HC3 (Human-
Computer Interfaces) was also relevant in a technical sense because
accessibility and usability were treated as engineering qualities that
affected requirements, interface decisions, validation tasks, and the
choice to complete a usability study and user manual. Finally,
SFWRENG 4C03 (Computer Networks \& Security) reinforced concerns around
secure external integrations, service boundaries, and the risks of
relying on networked or third-party components.

\subsection{Knowledge/Skills Outside of Courses}

At the same time, some of the most important knowledge for this project
came from outside formal coursework. We had to learn practical LLM
engineering, including prompt construction, tool-calling patterns, and
how to manage tradeoffs between latency, token cost, privacy, and
reliability when external AI services are part of the system. We also
had to work with browser and desktop automation tools in a much more
hands-on way than most courses require, dealing with asynchronous flows,
brittle UI behaviour, and environment-specific debugging. Coordinating a
two-language engineering toolchain across Python and TypeScript also
required stronger use of linting, formatting, and testing tools than a
single-course assignment usually demands.

Another major area of growth was learning how to convert engineering
evidence into design iteration. Running a usability study,
interpreting the results, and then turning those results into
architectural, interface, and documentation changes required more
judgment than solving a tightly scoped academic problem. It required us
to balance feasibility, maintainability, user value, and verification in
a way that felt much closer to real software engineering practice.
